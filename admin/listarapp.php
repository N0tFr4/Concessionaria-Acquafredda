...
<head>
    ...
    <link rel="stylesheet" href="../css/listarapp.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Lista rappresentanti</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card text-center mb-3" style="width: 40rem;">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Ecco la lista dei rappresentanti della concessionaria </h5>
                    <p class="card-text">
                            ...
                            if(mysqli_num_rows($result)!=0){
                                ...
                                echo "<table  class=\"table table-borderless \">";  
                                    ...
                                    while ($row = $result->fetch_assoc()) {   
                                        ...
                                        echo "<tr> \n";
                                            echo "<td>" . $row["cognome_rappresentante"] . "</td> \n";
                                            echo "<td>" . $row["nome_rappresentante"] . "</td> \n";
                                            echo "<td>" . $row["username_rappresentante"] . "</td> \n";  
                                            echo "<td>" . $row["azienda_rappresentante"] . "</td> \n";

                                            echo "<td>";
                                                echo "<a class=\"btn btn-primary\" href='modificarapp.php?id=" . $row['id_rappresentante'] . "'>Modifica</a>";
                                            echo "</td>";

                                            echo "<td>";
                                                echo "<a class=\"btn btn-primary\" href='eliminarapp.php?id=" . $row['id_rappresentante'] . "'>Elimina</a>";
                                            echo "</td>";
                                ...
                                echo "<script>alert('Nessun rappresentante presente nel DB');
