...
<body>
    ...
    <section class="hero">
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card text-center mb-3 card-section" style="width: 100rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <?php   
                            ...
                            if (!empty($produttrice)) {
                                $sql .= " WHERE auto.produttrice_auto = '$produttrice'";
                            }

                            //$sql = "SELECT auto.id_auto, auto.modello_auto, auto.produttrice_auto, auto.cavalli_auto, auto.cilindrata_auto, auto.alimentazione_auto, auto.anno_auto, auto.prezzo_auto, rappresentante.username_rappresentante FROM auto INNER JOIN rappresentante ON auto.id_rappresentante=  rappresentante.id_rappresentante";
                            $result = $conn->query($sql);
                                ...
                                echo "<table  class=\"table table-borderless \">";  
                                    ...
                                    while ($row = $result->fetch_assoc()) {   
                                        ...
                                        echo "<tr> \n";
                                            ...
                                            echo "<td>";
                                                echo "<a class=\"btn btn-primary\" href='eliminaauto.php?id=" . $row['id_auto'] . "'>Elimina</a>";
                                            echo "</td>";
                                        echo "</tr> \n";    
                                    }
                                echo "</table>\n";
