        ...
        <div class="container d-flex justify-content-center align-items-center vh-100">
            <div class="card text-center mb-3" style="width: 60rem;">
                ...
                <div class="d-flex align-items-start">
                    ...
                    <h5 class="card-title">Ecco la lista delle tue prenotazioni con i clienti </h5>
                    ...
                    <p class="card-text">
                        ...
                        <?php   
                            ...
                            $sql = "SELECT incontro.data_incontro, cliente.nome_cliente, cliente.cognome_cliente, auto.modello_auto, auto.produttrice_auto FROM auto INNER JOIN rappresentante ON auto.id_rappresentante=  rappresentante.id_rappresentante INNER JOIN incontro ON auto.id_auto = incontro.id_auto INNER JOIN cliente ON cliente.id_cliente = incontro.id_cliente WHERE rappresentante.username_rappresentante = '$username' ORDER BY incontro.data_incontro";
